...
/**
 * Defines the ruleset used for the Geniza API.
 *
 * This file owes its origin to the CodeIgniter4 standard.
 */
final class GenizaCodingStandard extends AbstractRuleset {
	public function __construct() {
		$this->name = 'Geniza Coding Standards';
